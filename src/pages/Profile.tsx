            ...
            <div className="mt-6">
              {activeTab === 'badge' && (
                <Card className={`${cardBg} rounded-2xl ${cardHoverEffect} animate-fade-in`}>
                  <CardHeader className="relative overflow-hidden p-6 pb-4 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-t-2xl">
                    ...
                    <div className="relative z-10">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div className="space-y-1">
                          ...
                          <p className="text-sm text-white/90 max-w-md">Complete challenges and unlock exclusive badges to showcase your learning journey</p>
                        </div>
                        <div className="flex items-center gap-3">
                          <div className="flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                            ...
                            <span className="text-sm font-medium text-white">Level {achievementLevel}</span>
                          </div>
                          <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                            <div className="w-5 h-5 rounded-full bg-gradient-to-br from-yellow-300 to-amber-400 flex items-center justify-center">
                              <Star className="w-3 h-3 text-amber-800 fill-current" />
                            </div>
                            <span className="text-sm font-medium text-white">{Math.floor(Math.random() * 15) + 5} Badges</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mt-6">
                        <div className="flex items-center justify-between mb-1">
                          <span className="text-xs font-medium text-white/80">Progress to next level</span>
                          <span className="text-xs font-medium text-white/80">
                            {Math.floor((userStats.hoursLearning % 10) * 10)}% Complete
                          </span>
                        </div>
                        <div className="w-full bg-white/20 rounded-full h-2">
                          <div 
                            className="bg-gradient-to-r from-yellow-300 to-amber-400 h-2 rounded-full transition-all duration-500 ease-out"
                            style={{ width: `${(userStats.hoursLearning % 10) * 10}%` }}
                          ></div>
                        </div>
                      </div>
                    </div>
                  ...
                  <CardContent className="pt-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6">
                      {/* Learning Badges */}
                      <div className={`group p-5 border rounded-2xl transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${
                        theme === 'dark' 
                          ? 'border-gray-700 bg-gradient-to-br from-gray-800/80 to-gray-800/40 hover:border-blue-500/30' 
                          : 'border-gray-200 bg-gradient-to-br from-blue-50/80 to-white hover:border-blue-300'
                      }`}>
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <div>
                            <h4 className={`font-semibold text-lg ${textColor}`}>Learning Badges</h4>
                            <p className={`text-xs ${textMuted} flex items-center gap-1`}>
                              <Clock className="w-3 h-3" /> Based on study time and progress
                            </p>
                          </div>
                        </div>
                      ...
                      <div className={`group p-5 border rounded-2xl transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${
                        theme === 'dark' 
                          ? 'border-gray-700 bg-gradient-to-br from-gray-800/80 to-gray-800/40 hover:border-orange-500/30' 
                          : 'border-gray-200 bg-gradient-to-br from-orange-50/80 to-white hover:border-orange-300'
                      }`}>
                        <div className="flex items-center gap-3 mb-4">
                          <div className={`p-2.5 rounded-xl shadow-sm ${
                            theme === 'dark' 
                              ? 'bg-orange-900/40 group-hover:bg-orange-900/60' 
                              : 'bg-orange-100 group-hover:bg-orange-200/80'
                          } transition-colors duration-300`}>
                          ...
                          <div>
                            <h4 className="font-semibold text-lg bg-gradient-to-r from-orange-500 to-pink-600 bg-clip-text text-transparent">
                              Streak Badges
                            </h4>
                            <p className={`text-xs ${textMuted} flex items-center gap-1`}>
                              <Flame className="w-3 h-3 text-orange-500" /> Keep the learning flame alive!
                            </p>
                          </div>
                        </div>
                        <div className="space-y-2">
                      ...
                      <div className={`group p-5 border rounded-2xl transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${
                        theme === 'dark' 
                          ? 'border-gray-700 bg-gradient-to-br from-gray-800/80 to-gray-800/40 hover:border-emerald-500/30' 
                          : 'border-gray-200 bg-gradient-to-br from-emerald-50/80 to-white hover:border-emerald-300'
                      }`}>
                        <div className="flex items-center gap-3 mb-4">
                          <div className={`p-2.5 rounded-xl shadow-sm ${
                            theme === 'dark' 
                          ...
                          <div>
                            <h4 className="font-semibold text-lg bg-gradient-to-r from-emerald-500 to-teal-600 bg-clip-text text-transparent">
                              Goal Badges
                            </h4>
                            <p className={`text-xs ${textMuted} flex items-center gap-1`}>
                              <Target className="w-3 h-3 text-emerald-500" /> Achieve your learning targets
                            </p>
                          </div>
                        </div>
                        <div className="space-y-2">
